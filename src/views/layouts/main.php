...
use gxcok\admin\web\AdminAsset;
...
<head>
    ...
    <![endif]-->
    <link rel="stylesheet" href="<?= $url ?>/css/chosen2.css"/>
</head>
<body class="no-skin">
<?php $this->beginBody() ?>
        ...
        <div class="footer-inner">
            <div class="footer-content">
                <span class="bigger-120">
                    <?= ArrayHelper::getValue(Yii::$app->params, 'companyName', '<span class="bolder"> gxcok.liu@qq.com </span> <a href="https://github.com/myloveGy/yii2-ace-admin" target="_blank">Yii2 Admin</a> 项目 ') ?>&copy;<?= date('Y') ?>
                </span>
            </div>
        </div>
    </div>
...
<?php if(!empty($this->blocks['javascript'])) { echo $this->blocks['javascript'];} ?>
</body>
</html>
<?php $this->endPage() ?>
